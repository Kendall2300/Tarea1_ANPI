...
if __name__ == "__main__":
    ...
    E, error, k = biseccion.biseccion(-5, 10, caso_1, 0.5, math.pi, 1e-10, 1000)
    
    print("\nEl valor de la ecuación de Kepler: ", E)
    print("\nEl error generado es: ", error)
    print("\nLas iteraciones realizadas: ", k)

    tiempo_biseccion = timeit.timeit(lambda: biseccion.biseccion(-5, 10, caso_1, 0.5, math.pi, 1e-10, 1000),
                                     number=1)
    ...
    xk2, error2, k2 = falsa_posicion.falsa_posicion(0,math.pi,caso_1,0.5,math.pi,1e-10,1000)

    print("\nEl valor de la ecuación de Kepler: ", xk2)
    print("\nEl error generado es: ", error2)
    print("\nLas iteraciones realizadas: ", k2, "\n")

    tiempo_falsaposicion = timeit.timeit(lambda: falsa_posicion.falsa_posicion(0,math.pi,caso_1,0.5,math.pi,1e-10,1000),
                                     number=1)
    ...
    xk3, error3, k3 = jarratt_.jarratt(1,caso_2, 0.5, pi, 1e-10, 1000)
    
    print("\nEl valor aproximado: ", xk3)
    print("\nEl error es: ", error3)
    print("\nIteraciones realizadas", k3)

    tiempo_jarratt = timeit.timeit(lambda: jarratt_.jarratt(1,caso_2, 0.5, pi, 1e-10, 1000),
                                     number=1)
    ...
    xk4, error4, k4 = potra_ptak.potra_ptak(1,caso_2, 5e-1, pi, 1e-10, 1000)
    
    print("\nEl valor aproximado: ", xk4)
    print("\nEl error es: ", error4)
    print("\nIteraciones realizadas", k4)

    tiempo_potakptak = timeit.timeit(lambda: potra_ptak.potra_ptak(1,caso_2, 5e-1, pi, 1e-10, 1000),
                                     number=1)
